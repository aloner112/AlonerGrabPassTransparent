...
public class AlonerGrabPass_MainTex : ScriptableRendererFeature
{
    [System.Serializable]
    public class FeatureSettings
    {
        public string profilerTag = "AlonerGrabPass_MainTex";
        public bool IsEnabled = true;
        public RenderPassEvent WhenToInsert = RenderPassEvent.AfterRenderingTransparents;
        public Material MaterialToBlit;
    }
    class AlonerGrabPass_MainTex_Pass : ScriptableRenderPass
    {
        string profilerTag;
        ...
        public AlonerGrabPass_MainTex_Pass(string profilerTag,
    ...
    AlonerGrabPass_MainTex_Pass grabPass;

    /// <inheritdoc/>
    public override void Create()
    {
        grabPass = new AlonerGrabPass_MainTex_Pass(
